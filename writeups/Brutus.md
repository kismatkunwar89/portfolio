...
## Credit
IppSec (youtube) [youtube](https://www.youtube.com/watch?v=bv08UcIL1po). This is my first machine, so I needed guidance and used his walkthrough as reference. This writeup follows the approach he teaches, especially command line parsing with regex and the way he analyzes challenges. For other machines I may use a similar approach while I build my own methodology.
